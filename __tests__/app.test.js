...
describe("GET/api/articles", () => {
  ...
  it("400: responds with an error if sort column is not valid", () => {
  ...
  it("200: responds with updated article", () => {
    ...
    return request(app)
      ...
      .then((res) => {
        ...
        expect(Object.keys(res.body.article)).toEqual(
...
describe("DELETE /api/comments/:comment_id", () => {
  it("should delete the given comment by its ID", () => {
    ...
    return request(app)
      ...
      .expect(204)
      .then(() => {
        return request(app).get(`/api/comments/${comment_id}`).expect(404);
      });
  });
